...
Trong nguyên tắc, sự phát triển này làm cho chúng tôi nhiệt tình về khoa học. Nếu khoa học mang tính tích lũy, nhiều nghiên cứu được công bố hơn sẽ cung cấp nhiều bằng chứng hơn. Chính điều này cho phép ta xây dựng nhiều lập luận mạnh mẽ hơn và loại bỏ lối ngụy biện của quá khứ. 

Tất nhiên, điều đó là không dễ dàng. Trong một tờ báo có tầm ảnh hưởng lớn, John Ioannidis ở Stanford chỉ trích quan điểm khoa học tự tích lũy và liên tục cải thiện. Bài báo với tiêu đề "Tại sao khoa học không nhất thiết phải tự điều chỉnh". Ông lập luận rằng các nghiên cứu thực địa thường có thể tồn tại ở trạng thái mà ở đó số lượng lớn đầu ra nghiên cứu được là nói về một chủ đề hoặc lý thuyết cụ thể, nhưng ở đó các ngụy biện cơ bản vẫn không bị phản đối và chỉ được duy trì. 

Vào những năm 1970,nhà tâm lý học Paul Meehl đã tìm thấy được trong một số nghiên cứu, có sự tương đồng chặt chẽ giữa lý thuyết và xu hướng thời trang. Bằng các lập luận, Meehl cho rằng nhiều lý thuyết không được cải tiến hay bác bỏ, chúng đơn giản “ biến mất “ khi con người bắt đầu hết hứng thú với chúng [@meehl1978theoretical]. 

Có một sự thật bất tiện là quá trình khoa học, khi bị phó mặc cho các thiết bị của chính nó, sẽ không tự động đưa chúng ta đến tất cả những điều tốt nhất có thể. Với lượng phát hiện nghiên cứu chưa từng có trong mỗi ngày, việc xem xét và thẩm định các các bằng chứng quan trọng hơn trong những gì họ đưa lên **in their entirety**. Phân tích tổng hợp có thể vô cùng hữu ích để đạt được vấn đề này, miễn là chúng ta vẫn thừa nhận hạn chế và thành kiến.


<br></br>

## Phân tích gộp là gì? {#what-are-mas}
...
Một trong những người sáng lập ra mô hình phân tích tổng hợp “Gene V. Glass”  đã mô tả “ phân tích của các phân tích “. Định nghĩa đơn giản cho chúng ta biết rất nhiều. Trong các nghiên cứu thường, các đơn vị phân tích là  số người, mẫu bệnh phẩm, quốc gia hoặc đối tượng. Trong phân tích tổng hợp, nghiên cứu chính **primary studies** trở thành các phân tích của chúng tôi.One of its founding fathers, Gene V. Glass, described meta-analysis as an "analysis of analyses" [@glass1976primary]. 

Mục đích của phân tích tổng hợp là kết hợp, tóm tắt và giải thích các bằng chứng liên quan đến một cách rõ ràng lĩnh vực của nghiên cứu hoặc câu hỏi của nghiên cứu [@lipsey2001practical, chapter 1]. Tuy nhiên, đó chỉ là một phương pháp để làm. Có ít nhất ba nghiên cứu riêng biệt nói lên tổng hợp bằng chứng từ nhiều nghiên cứu. [@cuijpers2016meta].

* **Traditional/Narrative Reviews**. Truyền thống/Đánh giá tường thuật. Cho đến những năm 1980, **narrative reviews** các bài phê bình tường thuật phổ biến nhất là dùng để tóm tắt một lĩnh vực nghiên cứu. Phê bình tường thuật thường được viết bởi các chuyên gia và các cơ quan lĩnh vực nghiên cứu. Không có quy tắc nghiêm ngặt về việc phải chọn các nghiên cứu trong một bài phê bình tường thuật như thế nào và làm thế nào xác nhận bài đánh giá.

* **Hệ thống bình duyệt**.  Hệ thống bình duyệt cố gắng tóm tắt bằng chứng bằng cách sử dụng các quy tắc rõ ràng và minh bạch. Trong đánh giá có hệ thống, các câu hỏi nghiên cứu được xác định trước, và có phương pháp luận rõ ràng, có thể lặp lại quá trình thông qua đó các nghiên cứu được chọn và xem xét. Các bài kiểm duyệt có hệ thống nhắm đến các bằng chứng **tất cả** có sẵn. Họ cũng đánh giá sự hợp lệ của các bằng chứng được sử dụng các tiêu chuẩn xác định trước và trình bày tổng hợp các kết quả một cách hệ thống. 

* **Phân tích tổng hợp**. Hầu hết các phân tích tổng hợp có thể được xem như là một dạng của đánh giá hệ thống nâng cao. Phạm vi phân tích tổng hợp được xác định rõ ràng từ trước, các nghiên cứu cũng được lựa chọn theo một cách có hệ thống và có thể tái thực hiện lại quá trình và nó cũng có những tiêu chuẩn rõ ràng mà qua đó tính hợp lệ của bằng chứng được đánh giá. Đó là lý do tại sao việc tìm các nghiên cứu được đặt tên "đánh giá hệ thống **và** phân tích tổng hợp". Tuy nhiên, có một khía cạnh làm cho các phân tích tổng hợp đặc biệt hướng tới việc kết hợp các kết quả từ các nghiên cứu trước đây theo các yếu tố **định lượng**.  Mục tiêu của phân tích tổng hợp là tích hợp các kết quả định lượng được báo cáo trong các nghiên cứu chọn lọc thành một ước tính số học. Ước tính này sau đó tổng hợp các kết quả cá nhân. Phân tích tổng hợp định lượng, ví dụ, ảnh hưởng của một loại thuốc, sự phổ biến của một bệnh, hoặc sự tương quan giữa hai tính chất, **trong tất cả các nghiên cứu**^[Tuyên bố này tất nhiên chỉ đúng nếu các kỹ thuật phân tích tổng hợp được áp dụng đúng và nếu kết quả của phân tích tổng hợp cho phương pháp tổng quát hóa.]. Do đó, chúng chỉ có thể được áp dụng cho các nghiên cứu báo cáo kết quả định lượng. So với các đánh giá có hệ thống, phân tích tổng hợp thường phải có tính độc lập hơn liên quan các loại bằng chứng được tóm tắt. Để thực hiện một phân tích tổng hợp, các nghiên cứu thường cần thiết phải sử dụng cùng một thiết kế đo lường và đưa ra cùng một can thiệp (see Chapter \@ref(pitfalls)).


```{block, type='boxinfo'}
**Dữ liệu phân tích tổng hợp cá nhân**

Tùy thuộc vào định nghĩa, cũng có một loại phương pháp tổng hợp bằng chứng thứ tư, được gọi là  **Dữ liệu phân tích tổng hợp cá nhân - IDP** [@riley2010meta]. Theo truyền thống, phân tích tổng hợp dựa trên **tổng hợp lại** kết quả tổng hợp của các nghiên cứu được tìm thấy trong các tài liệu được công bố (ví dụ: trung bình, độ lệch chuẩn hoặc tỷ lệ). Trong dữ liệu phân tích tổng hợp, dữ liệu **gốc** của tất cả các nghiên cướ được thu thập và kết hợp thành bộ dữ liệu lớn.  

Phân tích tổng hợp IPD có một số ưu thế. Ví dụ, có thể quy đổi dữ liệu bị thiếu và áp dụng các phương pháp thống kê theo cùng một cách trên tất cả các nghiên cứu. Hơn nữa, IPD có thể làm cho mọi thứ dễ dàng hơn để có thể khám phá các ảnh hưởng của kết quả của sự quan tâm. Theo truyền thống, chỉ được gọi **cấp độ nghiên cứu** biến số (Ví dụ: năm xuất bản, dân số được sử dụng trong nghiên cứu) có thể dùng bằng cách này. Tuy nhiên, nó các thông tin thường là mức **cấp độ người tham gia** (ví dụ: độ tuổi hoặc giới tính cá nhân) có thể đóng một vai trò là quan trọng của kết quả. Các biến số như vậy chỉ được thăm dò bằng phương pháp phân tích tổng hợp IPD.


Phương pháp tổng hợp IPD là một phương pháp tương đối mới và phần lớn các phân tích tổng hợp được tiến hành ngày nay vẫn còn các phân tích tổng hợp "truyền thống". Đây cũng là một lý do vì sao chúng ta không nói về các phương pháp tổng hợp IPD trong cuốn sách này. 

Điều này không liên quan gì đến việc phân tích tổng hợp truyền thống là ưu việt hơn. Ngược lại, Nó đơn giản là do việc làm cho tất cả các dữ liệu nghiên cứu được có sẵn một cách công khai không may là rất hiếm trong hầu hết các ngành gần đây. Trong khi tương đối dễ trích dẫn kết quả tổng hợp từ báo cáo các nghiên cứu được công bố, việc thu nhập dữ liệu ban đầu từ tất cả các nghiên cứu đều có thử thách. Ví dụ, trong nghiên cứu sinh học, dữ liệu của người tham gia cá nhân được khoảng 64% các nghiên cứu đã công bố [@riley2007evidence].
...
## "Các bài tập trong Mega-Silliness": Giai đoạn lịch sử {#lịch sử}

---

Phân tích tổng hợp không chỉ phát minh bởi một người duy nhất [@o2007historical].Những nỗ lực đầu tiên để tóm tắt thông kê ảnh hưởng của các nghiên cứu riêng biệt, nhưng các nghiên cứu tương tự có niên đại khoảng 100 năm, và có thể được liên kết hai trong số những nhà thống kê quan trọng nhất mọi thời đại, Karl Pearson and Ronald A. Fisher. 

Pearson, vào đầu thế kỷ 20, đã kết hợp những phát hiện về ảnh hưởng của việc tiêm chủng thương hàn trên khắp nước Anh để tính toán một ước tính [@shannon2016statistical]. Fisher, trong cuốn sách chuyên đề năm 1935 về thiết kế thí nghiệm, phương pháp tiếp cận được đề cập để phân tích dữ liệu từ nhiều nghiên cứu trong nghiên cứu nông nghiệp, và đã thừa nhận vấn đề mà kết quả nghiên cứu có thể thay đổi do vị trí và thời gian [@fisher19351he; @o2007historical]. 

\index{Sự khác biệt trung bình được chuẩn hóa}
\index{Mô hình ngẫu nhiên-Tác động}
\index{Lịch sử phân tích tổng hợp}

“Phân tích tổng hợp" và sự bắt đầu nổi lên của nó, tuy nhiên, có thể được truy trở lại một cuộc tranh chấp học thuật xảy ra giữa thế kỷ 20<sup>th</sup>. Năm 1952, nhà tâm lý học nổi tiếng người Anh Hans Juxrgen Eysenck đã xuất bản một bài báo trong đó ông tuyên bố rằng liệu pháp tâm lý (là phân tâm học Freudian) không có hiệu quả (Figure \@ref(fig:eysenck)). Nếu bệnh nhân khỏe hơn trong quá trình điều trị, đó là bởi vì tình trạng của họ có thể đã được cải thiện bởi những yếu tố không liên quan gì đến việc điều trị. Tệ hơn nữa, ông Eysenck cho rằng liệu pháp tâm lý thường sẽ cản trở bệnh nhân cải thiện sức khỏe hơn. 

Danh tiếng của liệu pháp tâm lý học đã trở nên nổi tiếng và điều đó đã không được phát hiện cho đến những năm 1970. Trong thời gian đó, Gene V. Glas đã phát triển một kỹ thuật mà ông gọi là "phân tích tổng hợp", cho phép tập hợp **Sự khác biệt trung bình được chuẩn hóa**^[tức là sự khác biệt về trung bình giữa hai nhóm, ví dụ như nhóm can thiệp và nhóm kiểm soát, được biểu thị bằng đơn vị độ lệch chuẩn của cả hai nhóm (xem chương \@ref(s-md)).]. tức là sự khác biệt về phương tiện giữa hai nhóm, ví dụ như nhóm can thiệp và nhóm kiểm soát, được biểu thị bằng đơn vị độ lệch chuẩn gộp của cả hai nhóm
Ứng dụng rộng rãi đầu tiên của kỹ thuật này là trong một bài báo đăng trên tạp chí **American Psychologist**, được viết bởi chính Mary L. Smith và Glass [@smith1977meta]. Trong nghiên cứu lớn này, kết quả từ 375 nghiên cứu với hơn 4000 người tham gia đã được kết hợp trong một phân tích tổng hợp. 

Nghiên cứu cho thấy các liệu pháp tâm lý có tác dụng chung là 0,68, có thể được coi là khá lớn. Công việc của Glass đã có một tác động to lớn bởi vì nó cung cấp bằng chứng định lượng rằng phán quyết của Eysenck là sai. Tuy nhiên, bản thân Eysenck không bị thuyết phục, gọi phân tích tổng hợp là "sự từ bỏ học thuật" và "bài tập về sự ngớ ngẩn lớn" [@eysenck1978exercise].

(tham khảo:eysenck) Hans Jürgen Eysenck ([_Sirswindon/CC BY-SA 3.0_](#attr)).


```{r eysenck, fig.cap='(ref:eysenck)', fig.scap="Hans Jürgen Eysenck.",  out.width='35%', message = F, echo = F, fig.align='right'}
library(OpenImageR)   # Gọi gói OpenImager
knitr::include_graphics('images/eysenck_col.jpg')  # Xuất hình ảnh với tên eysenck_col
```


Ngày nay chúng ta biết rằng nghiên cứu Smith và Glass có thể đánh giá cao tác dụng của liệu pháp tâm lý trị liệu vì nó đã không kiểm soát thành kiến trong các nghiên cứu được đưa vào [@cuijpers2019eysenck]. Tuy nhiên, phát hiện cơ bản rằng một số liệu pháp tâm lý có hiệu quả đã được chứng thực bởi vô số phân tích dữ liệu khác trong những thập kỷ tiếp theo. Phản ứng của Eysenck không thể thay đổi phân tích tổng hợp đó sớm trở thành một phương pháp được sử dụng phổ biến trong các lĩnh vực nghiên cứu khác nhau. 

Phương pháp phân tích tổng hợp sau đó đã liên tục được chỉnh sửa kể từ thời điểm.  Cùng một thời gian phát triển phương pháp tổng hợp phân tích của mình, Hunter và Smith bắt đầu tạo ra loại ra kỹ thuật phân tích tổng hợp riêng của họ nhấn mạnh vào việc hiệu chỉnh của các hiện vật đo lường [@schmidt1977development; @hunter2004methods]. 

Phân tích tổng hợp được đưa vào y học thông qua các công trình đột phá của Peter Elwood và Archie Corchrane, trong số những người khác, những người đã được sử dụng phân tích tổng hợp để chỉ ra rằng aspirin có tác dụng phòng ngừa nhỏ, nhưng về mặt thống kê và lâm sàng có liên quan đến sự hồi phục của các cơn đau tim [@peto1980aspirin; @elwood2006first; @o2007historical]. 

Vào những năm 80, Rebecca DerSimonian and Nan Laird đã giới thiệu một cách tiếp cận để tính toán các phân tích tổng hợp ngẫu nhiên-ảnh hưởng (xem Chương \@ref(rem)) đã được sử dụng cho đến ngày nay [@dersimonian1986meta]. Vô số sáng kiến khác và đã giúp tăng tính ứng dụng, mạnh mẽ và tính linh hoạt của các phương pháp siêu phân tích trong bốn thập kỷ qua.  
...
```{block2, type='boxinfo'}
**Sự hợp tác Cochrane và Campbell**

Hơp tác [**Cochrane**](https://www.cochrane.org/) (hoặc đơn giản **Cochrane**), đã được tìm thấy năm 1993 và sau đó lấy tên Archie Cochrane, đã đóng mọt vai trò quan trọng trong sự phát triển ứng dụng phân tích tổng hợp. Cochrane is an international network of researchers, professionals, patients and other relevant stakeholders who "work together to produce credible, accessible health information that is free from commercial sponsorship and other conflicts of interest". 
